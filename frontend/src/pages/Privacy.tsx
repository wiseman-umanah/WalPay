...
export default function PrivacyPolicy() {
  ...
  const structuredData = {
    ...
    "@type": "WebPage",
    name: "WalP Privacy Policy",
    url: `${appUrl.replace(/\/$/, "")}/privacy`,
    description:
      "WalP privacy policy describing data collection, usage, and retention practices for Flow payment merchants.",
    isPartOf: {
      "@type": "WebSite",
      url: appUrl,
      name: "WalP",
  ...
  return (
    <>
      <Seo
        ...
        description="Understand how WalP stores merchant data, handles OTP authentication, and secures Flow wallet interactions."
      ...
      <div className="mx-auto max-w-4xl px-6 py-16 space-y-8">
        ...
        <section className="space-y-6 text-sm leading-relaxed text-slate-300">
          <p>
            WalP stores merchant account details (email, business profile, Flow wallet address) to operate your
          ...
          <p>
            For questions or data requests, reach the WalP team via the email channel provided during onboarding.
          </p>
        </section>
